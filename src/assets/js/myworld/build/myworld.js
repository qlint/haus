! function t(e, n, i) {
    ...
    5: [function(t, e, n) {
        ...
        s(i, o), i.prototype.getZoom = function() {
            ...
            switch (t) {
                default: return this.news
            }
        }, i.prototype.getExcursions = function(t) {
            switch (t) {
                default: return this.excursions
            }
            ...
            var n = {
                ...
                icon: "assets/img/pins/marker.png",
                infoWindow: {
    ...
    7: [function(t, e, n) {
        ...
        s(i, o), i.prototype.addCity = function(t) {
            ...
            var n = {
                latitude: this.data("latitude"),
                longitude: this.data("longitude"),
                icon: "assets/img/pins/" + this.data("code") + ".png",
                infoWindow: {
                    contentString: '<div class="right counpin"><img src="assets/img/country/' + this.data("code") + '.png" /><h3>' + this.data("name") + '</h3><span class="rating">' + this.data("rating") + "</span></div>",
    ...
    8: [function(t, e, n) {
        ...
        s(i, o), i.prototype.getZoom = function() {
            ...
            var n = {
                latitude: this.data("latitude"),
                longitude: this.data("longitude"),
                icon: "assets/img/pins/" + this.place.data("type") + ".png",
                infoWindow: {
                    contentString: '<div class="left citypin"><h3>' + this.data("name") + "</h3></div>",
    ...
    9: [function(t, e, n) {
        ...
        s(i, o), i.prototype.getZoom = function() {
            ...
            var n = {
                ...
                icon: "assets/img/pins/route.png"
            };
    ...
    10: [function(t, e, n) {
        ...
        function i(t, e) {
            this.id = e.id, this.name = e.name, this._data = {}, this.className = t, this.marker = !1, "undefined" != typeof e.code && this.data("code", e.code), "undefined" != typeof e.name && this.data("name", e.name), "undefined" != typeof e.latitude && this.data("latitude", e.latitude), "undefined" != typeof e.longitude && this.data("longitude", e.longitude), this.data("rating", (5 * Math.random()).toFixed(2)), this.data("comments", Math.floor(1e3 * Math.random()))
        }
        i.prototype.data = function(t, e) {
    ...
    12: [function(t, e, n) {
        ...
        s(i, o), i.prototype.getZoom = function() {
            ...
            var n = {
                latitude: this.data("latitude"),
                longitude: this.data("longitude"),
                icon: "assets/img/pins/" + this.data("type") + ".png",
                infoWindow: {
                    contentString: '<div class="left citypin"><h3>' + this.data("name") + "</h3></div>",
                    pixelOffset: new google.maps.Size(30, 50)
                }
    ...
    13: [function(t, e, n) {
        ...
        s(i, o), i.prototype.getZoom = function() {
            ...
            var n = {
                latitude: this.data("latitude"),
                longitude: this.data("longitude"),
                icon: "assets/img/pins/" + this.company.data("type") + ".png",
                infoWindow: {
                    contentString: '<div class="left citypin"><h3>' + this.data("name") + "</h3></div>",
                    pixelOffset: new google.maps.Size(30, 50)
                }
